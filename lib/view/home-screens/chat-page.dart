        ...
        title: Row(
          children: [
            InkWell(
              onTap: () {
                Navigator.of(context).pop(MaterialPageRoute(
                  builder: (context) => MatchesChatPage(),
                ));
            ...
            buildCircleProfilePicture(
                25, widget.image), //TODO add profile image accordingly
            SizedBox(
              width: 20,
            ),
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    widget.name, //TODO pass Dog NAme
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Row(
                      mainAxisAlignment: chats[index].byMe
