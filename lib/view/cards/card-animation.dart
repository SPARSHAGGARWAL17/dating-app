...
class _SwapCardState extends State<SwapCard>
  ...
  @override
  void didUpdateWidget(covariant SwapCard oldWidget) {
...
class CardAnimation {
  static Animation<Alignment> frontCardAlign(
    ...
    if (_SwapCardState._trigger == TriggerDirection.none) {
      endX = beginAlign.x > 0
    ...
    } else if (_SwapCardState._trigger == TriggerDirection.left) {
      endX = beginAlign.x - swipeEdge;
      endY = beginAlign.y + 0.5;
    }
    /* Trigger Swipe Up or Down */
    else if (_SwapCardState._trigger == TriggerDirection.up ||
        _SwapCardState._trigger == TriggerDirection.down) {
      var beginY =
          _SwapCardState._trigger == TriggerDirection.up ? -10 : 10;
